...
export default function ImageBlock(props) {
    ...
    const justifyContent = styles.justifyContent ? mapStylesToClassNames({ justifyContent: styles.justifyContent }) : null;

    return (
        <img
            id={cssId}
            className={classNames('sb-component', 'sb-component-block', 'sb-component-image-block', cssClasses, justifyContent)}
            src={url}
            alt={altText || ''}
            title={caption}
